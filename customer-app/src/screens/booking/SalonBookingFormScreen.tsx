...
type Props = NativeStackScreenProps<RootStackParamList, 'SalonBookingForm'>;

export default function SalonBookingFormScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <TopAppBar title="Visiting Shop Booking" onBackPress={() => navigation.goBack()} />
      ...
      >
        ...
        <SectionHeader title="Appointment Time" style={styles.sectionHeader} />
        <DatePicker 
          date={date} 
          onChange={setDate} 
